...
const InfoBar = () => {
    return (
        <div className="bg-white text-black p-5 rounded-md w-full flex flex-col gap-3 text-start">
            ...
            <p className="text-[0.6rem]"><b>Note: </b>You can use filter as upper or lower case. Or you can create filters as you wish</p>
            <ul className="flex flex-wrap">
                <FilterBox text="SEARCH:TURKEYGROUP:CURRENCY" />
                <FilterBox text="Search: Group:currency" />
                <FilterBox text="Search:Turkey Group:" />
                <FilterBox text="Search:Turkey" />
                <FilterBox text="Group:Currency" />
            </ul>
            
            <h5>Grouping Fields:</h5>
            <p className="text-[0.6rem]"><b>Note: </b>All fields listing below, you can use them as lower or upper case. But if you want to create own filter you have to add 'group:' at head of field and you can not change the field format.</p>
            <ul className="flex">
